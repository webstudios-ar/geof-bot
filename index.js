  ...
  if (cmd === 'normativas') {
    ...
    const embedDos = new EmbedBuilder()
      ...
      .setDescription(
        ...
        `${SEP} No revela su condición a nadie ajeno a la rama\n\n` +
        ...
        `**Legajos**\n` +
        `${SEP} El ${rol(ROL_ANALISTA, 'Analista')} los mantiene actualizados\n` +
    ...
    const peso = pesar([embedUno, embedDos]);
    if (peso > 6000) console.warn(`[NORMATIVAS] Pesa ${peso}/6000 — Discord lo va a rechazar.`);
